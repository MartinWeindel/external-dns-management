...
func (s *expState) UpdateProvider(logger logger.LogContext, obj *dnsutils.DNSProviderObject) reconcile.Status {
	...
	spec := obj.Spec()
	providerType := providerTypeToGenerated(spec.Type)
	ref := spec.SecretRef
	localref := *ref
	ref = &localref
	if ref.Namespace == "" {
	...
	gspec := &generated.DNSProviderSpec{
...
func providerTypeFromGenerated(ptype generated.ProviderType) string {
	if ptype == nil {
		return ""
	}
	switch ptype.(type) {
	case *generated.CloudflareDNS:
		return "cloudflare-dns"
	case *generated.AWSRoute53:
		return "aws-route53"
	case *generated.AzureDNS:
		return "azure-dns"
	case *generated.OpenstackDesignate:
...
func providerTypeToGenerated(typename string) generated.ProviderType {
	switch typename {
	case "cloudflare-dns":
		return &generated.CloudflareDNS{}
	case "aws-route53":
		return &generated.AWSRoute53{}
	case "azure-dns":
		return &generated.AzureDNS{}
	case "openstack-designate":
		return &generated.OpenstackDesignate{}
	}
	return nil
}
